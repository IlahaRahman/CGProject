...
export class MyGarden extends CGFobject {
    constructor(scene, rows, cols) {
        ...
        for (let i = 0; i < this.rows; i++) {
            for (let j = 0; j < this.cols; j++) {
                ...
                flower.setPosition(x, 0, z); // Set position of the flower, ensuring y is 0
    ...
    display() {
        ...
        for (let i = 0; i < this.flowers.length; i++) {
            ...
            this.scene.translate(flower.position[0], flower.position[1], flower.position[2]); // Translate to flower position
